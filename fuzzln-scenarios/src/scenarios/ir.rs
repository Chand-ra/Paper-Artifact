...
use fuzzln::noise::NoiseConnection;
use fuzzln::scenarios::{Scenario, ScenarioError, ScenarioResult};
...
///
/// The program is expected to be well-formed and produced by `fuzzln-ir`'s
